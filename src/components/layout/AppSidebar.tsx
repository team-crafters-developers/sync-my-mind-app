...
import { 
  Home, BookOpen, Heart, MessageCircle, 
  TestTube, Crown, User, Settings,
...
const navigationItems = [
  ...
  { title: "Notes", url: "/notes", icon: BookOpen, badge: "AI" },
  { title: "Wellness", url: "/wellness", icon: Heart, badge: null },
  { title: "AI Assistant", url: "/ai-assistant", icon: MessageCircle, badge: "Zenith" },
  { title: "Tests", url: "/tests", icon: TestTube, badge: "New" },
  { title: "Premium Hub", url: "/premium", icon: Crown, badge: "Pro" },
];
  ...
  return (
    <Sidebar className={isCollapsed ? "w-16" : "w-72"} collapsible="icon">
      ...
      <SidebarContent className="px-2">
                          ...
                          {item.badge && (
                            <Badge 
                              ...
                              className={`text-xs px-2 ${
                                item.badge === "Pro" ? "gradient-primary text-white" : ""
                              } ${
                                item.badge === "AI" ? "bg-academic text-academic-foreground" : ""
                              }`}
                            >
                              {item.badge}
                            </Badge>
        ...
        {!isCollapsed && (
          <div className="mt-4 p-3 rounded-lg bg-gradient-to-br from-academic/10 to-wellness/10 border border-primary/20">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-muted rounded-full h-2">
                <div 
                  className="gradient-academic h-2 rounded-full transition-all duration-500" 
                  style={{ width: '58%' }}
                ></div>
              </div>
